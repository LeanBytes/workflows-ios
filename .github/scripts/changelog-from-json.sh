...
# so the GitHub Release notes and the in-product changelog stay aligned.
#
# Inputs (env vars):
...
# ::warning:: and exit 0 with empty stdout. The publish jobs tolerate
# empty notes and fall back to a generic release title.
